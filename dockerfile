...
FROM golang:latest@sha256:595c7847cff97c9a9e76f015083c481d26078f961c9c8dca3923132f51fe12f1 AS serverbuilder
WORKDIR /app
COPY go.mod go.sum ./
...
FROM node:lts-alpine@sha256:01743339035a5c3c11a373cd7c83aeab6ed1457b55da6a69e014a95ac4e4700b AS uibuilder
WORKDIR /app
